import { Tag, tagsTableCols } from '@plentyag/app-ignition-tag-registry/src/common/types';
...
export interface UseTagFormGenConfig {
  tag?: Tag;
  username: string;
}

export interface UseTagFormGenConfigReturn extends FormGen.Config {}

export const useTagFormGenConfig = ({ tag, username }: UseTagFormGenConfig): UseTagFormGenConfigReturn => {
  ...
  return {
    ...
    title: isUpdating ? 'Edit Tag' : 'Create Tag',
